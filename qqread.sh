 ...
 ​ ​​xyhtxyqm​​(){  
 ​ ​rw=​​"​​新用户填写邀请码​​"​  
 ​ ​zx=​​$(​​curl -s -H ​​"​​Cookie:​​$ck​​​"​​ ​​"​​​$url​​/inivite/fillcode?code=402887545​"​​​)​  
 ​ ​jg  
 ​ ​}  
 ​ ​​xzydkwjl​​(){  
 ​ ​rw=​​"​​选择阅读口味奖励​​"​  
 ...
 ​ ​rw=​​"​​看小视频​​"​  
 ​ ​ye  
 ​ ​vc=​​$((​​$(echo ​​$ye​​ ​​|​​ grep ​​-​​o "videoCount.​​*​​" ​​|​​ cut ​​-​​d '"' ​​-​​f​​2​​ ​​|​​ grep ​​-​​o "[​​0​​​-​​​9​​]​​*​​")​​+​​​1​​​))​  
 ​ ​lm=​​$((​​$(echo ​​$ye​​ ​​|​​ grep ​​-​​o "limit.​​*​​" ​​|​​ cut ​​-​​d '"' ​​-​​f​​2​​ ​​|​​ grep ​​-​​o "[​​0​​​-​​​9​​]​​*​​")​​+​​​1​​​))​  
 ​ ​if​ [ ​​$vc​​ ​-ne​ ​​$lm​​ ]  
 ...
 ​ ​jg  
 ​ ​elif​ [ ​​$bxn​​ ​-eq​ 0 ]  
 ​ ​then​ ​echo​ ​​$rw​​今日已完成，明天再领  
 ​ ​else​ ​echo​ ​​$rw​​暂不可领，请等待​​$((​​sxt​​/​​​1000​​​))​​秒  
 ​ ​fi  
 ​ ​}  
 ​ ​​kspdjl​​(){  
 ​ ​rw=​​"​​看视频得奖励​​"​  
 ...
 ​ ​for​ ​​((​​i​​=​​​1​​;i​​<​​$((zs​​+​​​1​​​))​​​;​​i++))  
 ​ ​do​   
 ​ ​echo​ ​​$dt​​ 总共有​​$zs​​个账户，正在执行第​​$i​​个账户  
